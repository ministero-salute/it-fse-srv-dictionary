...
public class CfUtility {
	...
	public static final String ERROR_REQ_NULL = "Il codice fiscale nella richiesta deve essere valorizzato.";
	public static final String ERROR_REQ_NOT_VALID = "Il codice fiscale nella richiesta deve essere valido.";
	
	public static boolean isValidCf(final String cfIn) {
		return validaCF(cfIn) == CfUtility.CF_OK_16
				|| validaCF(cfIn) == CfUtility.CF_OK_11
				|| validaCF(cfIn) == CfUtility.CF_ENI_OK
				|| validaCF(cfIn) == CfUtility.CF_STP_OK;
	}

	private static int validaCF(String cfIn) {
