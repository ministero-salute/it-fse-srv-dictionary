...
public class OpenApiCFG {
	...
	public OpenApiCustomiser openApiCustomiser() {
		...
		return openApi -> {
			...
			openApi.getPaths().get("/v1/terminology/{format}").getPost().security(securityReqGOV);
			openApi.getPaths().get("/v1/terminology/{oid}/{version}").getDelete().security(securityReqGOV);
		};
	}
