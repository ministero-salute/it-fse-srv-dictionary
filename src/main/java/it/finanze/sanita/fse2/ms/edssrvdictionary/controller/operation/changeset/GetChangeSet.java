...
// OpenAPI descriptor
@Operation(
    summary = "Recupera il change-set attraverso la data di ultimo aggiornamento",
    description = "Restituisce un on-the-fly snapshot per l'istante temporale richiesto"
)
@ApiResponses(
    value = {
        @ApiResponse(
